-- SQL CORRIGIDO para traduzir tabelas e colunas para Português
...
-- 2. RENOMEAR COLUNAS - TABELA USUARIOS
...
-- 12. RECRIAR FOREIGN KEYS COM NOVOS NOMES
-- Remover constraints antigas
ALTER TABLE unidades DROP CONSTRAINT IF EXISTS units_company_id_fkey;
ALTER TABLE profissionais DROP CONSTRAINT IF EXISTS professionals_unit_id_fkey;
ALTER TABLE servicos DROP CONSTRAINT IF EXISTS services_professional_id_fkey;
ALTER TABLE disponibilidade DROP CONSTRAINT IF EXISTS availability_professional_id_fkey;
ALTER TABLE horarios_disponiveis DROP CONSTRAINT IF EXISTS time_slots_professional_id_fkey;
ALTER TABLE agendamentos DROP CONSTRAINT IF EXISTS appointments_user_id_fkey;
ALTER TABLE agendamentos DROP CONSTRAINT IF EXISTS appointments_professional_id_fkey;
ALTER TABLE agendamentos DROP CONSTRAINT IF EXISTS appointments_unit_id_fkey;
ALTER TABLE agendamento_servicos DROP CONSTRAINT IF EXISTS appointment_services_appointment_id_fkey;
ALTER TABLE agendamento_servicos DROP CONSTRAINT IF EXISTS appointment_services_service_id_fkey;
ALTER TABLE avaliacoes DROP CONSTRAINT IF EXISTS reviews_appointment_id_fkey;
ALTER TABLE avaliacoes DROP CONSTRAINT IF EXISTS reviews_user_id_fkey;
ALTER TABLE avaliacoes DROP CONSTRAINT IF EXISTS reviews_professional_id_fkey;

-- Recriar constraints
ALTER TABLE unidades ADD CONSTRAINT unidades_empresa_id_fkey 
  FOREIGN KEY (empresa_id) REFERENCES empresas(id) ON DELETE CASCADE;
ALTER TABLE profissionais ADD CONSTRAINT profissionais_unidade_id_fkey 
  FOREIGN KEY (unidade_id) REFERENCES unidades(id) ON DELETE CASCADE;
ALTER TABLE servicos ADD CONSTRAINT servicos_profissional_id_fkey 
  FOREIGN KEY (profissional_id) REFERENCES profissionais(id) ON DELETE CASCADE;
ALTER TABLE disponibilidade ADD CONSTRAINT disponibilidade_profissional_id_fkey 
  FOREIGN KEY (profissional_id) REFERENCES profissionais(id) ON DELETE CASCADE;
ALTER TABLE horarios_disponiveis ADD CONSTRAINT horarios_disponiveis_profissional_id_fkey 
  FOREIGN KEY (profissional_id) REFERENCES profissionais(id) ON DELETE CASCADE;
...
ALTER TABLE agendamentos ADD CONSTRAINT agendamentos_unidade_id_fkey 
  FOREIGN KEY (unidade_id) REFERENCES unidades(id) ON DELETE CASCADE;
ALTER TABLE agendamento_servicos ADD CONSTRAINT agendamento_servicos_agendamento_id_fkey 
  FOREIGN KEY (agendamento_id) REFERENCES agendamentos(id) ON DELETE CASCADE;
ALTER TABLE agendamento_servicos ADD CONSTRAINT agendamento_servicos_servico_id_fkey 
  FOREIGN KEY (servico_id) REFERENCES servicos(id) ON DELETE CASCADE;
ALTER TABLE avaliacoes ADD CONSTRAINT avaliacoes_agendamento_id_fkey 
  FOREIGN KEY (agendamento_id) REFERENCES agendamentos(id) ON DELETE CASCADE;
ALTER TABLE avaliacoes ADD CONSTRAINT avaliacoes_usuario_id_fkey 
  FOREIGN KEY (usuario_id) REFERENCES users(id) ON DELETE CASCADE;
ALTER TABLE avaliacoes ADD CONSTRAINT avaliacoes_profissional_id_fkey 
  FOREIGN KEY (profissional_id) REFERENCES profissionais(id) ON DELETE CASCADE;
...
-- Recriar políticas em português
...
-- Finalizado! Database 100% em português
